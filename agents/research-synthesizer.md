...
description: >
  Delegate to this agent when you need to integrate evidence from multiple research
  agents into a coherent synthesis organized by decision area. It reads all evidence
  files, cross-references findings, and produces SYNTHESIS.md mapping evidence to
  the decision areas defined in scope. It does not make design decisions.
model: opus
disallowedTools:
  - Bash
  - WebSearch
