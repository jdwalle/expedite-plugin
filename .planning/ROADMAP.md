...
- [ ] **Phase 25: State Splitting and Hook Infrastructure** - Split monolithic state.yml into 5 scoped files; build Node.js hook scaffolding with schema validation and non-state passthrough
...
| 25. State Splitting + Hooks | v2.0 | 0/TBD | Not started | - |
